...
namespace NaprstekSmithInterpolationV1
{
    public static class Globals
    {
        //*USER-INPUT VARIABLES
        public static string inputFile = "Sudbury.txt"; //raw data file with the format of X - Y - Value - Line number, tab delimited
        public static string outputFile = "Sudbury-50m250m25x.txt"; //output file
        public static double cellSize = 150; //edge size of each square cell in metres
