    ...
    public class Execute : BaseForm
    {
        ...
        public static void Main()
        {
            ...
            for (int k = 0; k < X.Count; k++)
            {
                ...
                xposit[xPos, yPos] = Convert.ToDouble(xPos) * Globals.cellSize;
                yposit[xPos, yPos] = Convert.ToDouble(yPos) * Globals.cellSize;
                tempX[xPos, yPos] += X[k] - xposit[xPos, yPos]; //Add the x pos of that reading to the cell.
            ...
            for (int k = 0; k < X.Count; k++)
            {
                ...
                xpositf[xPos, yPos] = Convert.ToDouble(xPos) * Globals.cellSizeF;
                ypositf[xPos, yPos] = Convert.ToDouble(yPos) * Globals.cellSizeF;
