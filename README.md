...
**If you use this interpolation method for any publications, please cite the above paper! Thanks!**

%%%%%%%%
**USAGE**
%%%%%%%%

Run NSI_V6.exe to use the method, using the "MTG_config.txt" to define user variables. All source code is included.
...
Feel free to email me if you have any issues or questions.
