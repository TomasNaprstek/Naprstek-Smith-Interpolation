...
namespace NaprstekSmith
{
    ...
    public class Execute : BaseForm
    {
        ...
        public static void Main()
        {
            ...
            Globals.outputFile = Globals.inputFile + "-" + Globals.cellSize + "m" + Globals.interpDist + "m" + Globals.totalLoop + "x" + ".txt";
            ...
            myfile2.WriteLine("Output grid file (*.grd): " + Globals.inputFile + "-" + Globals.cellSize + "m" + Globals.interpDist + "m" + Globals.totalLoop + "x");
